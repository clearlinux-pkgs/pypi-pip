...
Source0  : https://files.pythonhosted.org/packages/da/bf/1bdbe62f5fbde085351693e3a8e387a59f8220932b911b1719fe65efa2d7/pip-23.1.tar.gz
...
%prep
%setup -q -n pip-23.1
cd %{_builddir}/pip-23.1
pushd ..
cp -a pip-23.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681748310
