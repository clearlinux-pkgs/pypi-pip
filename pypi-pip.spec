...
Source0  : https://files.pythonhosted.org/packages/b5/16/5e24bf63cff51dcc169f43bd43b86b005c49941e09cc3482a5b370db239e/pip-23.0.tar.gz
...
%prep
%setup -q -n pip-23.0
cd %{_builddir}/pip-23.0
pushd ..
cp -a pip-23.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675183180
