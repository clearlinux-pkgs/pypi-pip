...
Version  : 24.1.1
Release  : 176
URL      : https://files.pythonhosted.org/packages/c0/d0/9641dc7b05877874c6418f8034ddefc809495e65caa14d38c7551cd114bb/pip-24.1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/c0/d0/9641dc7b05877874c6418f8034ddefc809495e65caa14d38c7551cd114bb/pip-24.1.1.tar.gz
...
%prep
%setup -q -n pip-24.1.1
cd %{_builddir}/pip-24.1.1
pushd ..
cp -a pip-24.1.1 buildavx2
popd
pushd ..
cp -a pip-24.1.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719505229
