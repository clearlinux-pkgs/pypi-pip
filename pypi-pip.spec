...
Version  : 24.1
Release  : 175
URL      : https://files.pythonhosted.org/packages/df/60/7538a9cd4d76829c2f585b73d6e400c833a1769408451c813354c58de6cc/pip-24.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/df/60/7538a9cd4d76829c2f585b73d6e400c833a1769408451c813354c58de6cc/pip-24.1.tar.gz
...
%prep
%setup -q -n pip-24.1
cd %{_builddir}/pip-24.1
pushd ..
cp -a pip-24.1 buildavx2
popd
pushd ..
cp -a pip-24.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718985351
