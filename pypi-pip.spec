...
Source0  : https://files.pythonhosted.org/packages/4b/30/e15b806597e67057e07a5acdc135216ccbf76a5f1681a324533b61066b0b/pip-22.2.2.tar.gz
...
%prep
%setup -q -n pip-22.2.2
cd %{_builddir}/pip-22.2.2
pushd ..
cp -a pip-22.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659647845
