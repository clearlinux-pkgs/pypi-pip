...
Source0  : https://files.pythonhosted.org/packages/f8/08/7f92782ff571c7c7cb6c5eeb8ebbb1f68cb02bdb24e55c5de4dd9ce98bc3/pip-22.3.tar.gz
...
%prep
%setup -q -n pip-22.3
cd %{_builddir}/pip-22.3
pushd ..
cp -a pip-22.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665850893
...
cp %{_builddir}/pip-%{version}/src/pip/_vendor/certifi/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pip/f138a97503337a68b54509f451bfdc3a3c927787 || :
