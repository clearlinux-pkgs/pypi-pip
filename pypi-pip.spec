...
Source0  : https://files.pythonhosted.org/packages/47/3e/68beeeeb306ea20ffd30b3ed993f531d16cd884ec4f60c9b1e238f69f2af/pip-25.0.tar.gz
...
%prep
%setup -q -n pip-25.0
cd %{_builddir}/pip-25.0
pushd ..
cp -a pip-25.0 buildavx2
popd
pushd ..
cp -a pip-25.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737993868
