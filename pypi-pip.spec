...
Source0  : https://files.pythonhosted.org/packages/12/3d/d899257cace386bebb7bdf8a872d5fe3b935cc6381c3ddb76d3e5d99890d/pip-24.1.2.tar.gz
...
%prep
%setup -q -n pip-24.1.2
cd %{_builddir}/pip-24.1.2
pushd ..
cp -a pip-24.1.2 buildavx2
popd
pushd ..
cp -a pip-24.1.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720476457
