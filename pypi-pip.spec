...
Source0  : https://files.pythonhosted.org/packages/b7/06/6b1ad0ae8f97d7a0d6f6ad640db10780578999e647a9593512ceb6f06469/pip-23.3.2.tar.gz
...
%prep
%setup -q -n pip-23.3.2
cd %{_builddir}/pip-23.3.2
pushd ..
cp -a pip-23.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702929364
