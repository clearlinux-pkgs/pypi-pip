...
Source0  : https://files.pythonhosted.org/packages/94/59/6638090c25e9bc4ce0c42817b5a234e183872a1129735a9330c472cc2056/pip-24.0.tar.gz
...
%prep
%setup -q -n pip-24.0
cd %{_builddir}/pip-24.0
pushd ..
cp -a pip-24.0 buildavx2
popd
pushd ..
cp -a pip-24.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706999141
