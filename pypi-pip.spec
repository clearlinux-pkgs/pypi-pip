...
Source0  : https://files.pythonhosted.org/packages/1f/7f/4da15e07ccd11c84c1ccc8f6e24288d5e76c99441bf80e315b33542db951/pip-23.3.1.tar.gz
...
%prep
%setup -q -n pip-23.3.1
cd %{_builddir}/pip-23.3.1
pushd ..
cp -a pip-23.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698019226
